...
import com.example.stalker.app.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
    ...
    private OAuthAuthenticationListener mListener = new OAuthAuthenticationListener();
    ...
    public InstagramApp(Context context, String clientId, String clientSecret,
        ...
        mAuthUrl = AUTH_URL + "?client_id=" + clientId + "&redirect_uri="
                + mCallbackUrl + "&response_type=code&display=touch&scope=public_content";
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.d(TAG, "Got name: " + name + ", bio [" + bio + "]");
                } catch (Exception ex) {
                    what = WHAT_ERROR;
                    ex.printStackTrace();
                }
    ...
    public class OAuthAuthenticationListener {
        void onSuccess() {};
